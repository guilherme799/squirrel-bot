...
export class AdminBanishCommandHandler implements ICommandHandler {
  ...
  usage = `${ConfigService.prefix}ban @marcar_membro ou ${ConfigService.prefix}ban (mencionando uma mensagem)`;
  ...
  private throwIfUserCannotBeRemoved(
    ...
    let botJid = this.getUserJid([ConfigService.botConfig.phoneNumber]);
